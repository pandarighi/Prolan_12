...
public class mainHewan {
    ...
    public static void main(String[] args) {
        ...
        ver.setDesc(" (Vertebrata adalah subfilum dari Chordata, mencakup semua hewan yang memiliki tulang belakang.)");
        String v = ver.getDesc();
        generic<String> rep = new  generic<>();
        rep.setDesc(" (Reptil adalah sebuah kelompok hewan yang berdarah dingin dan memiliki sisik yang menutupi tubuhnya.)");
